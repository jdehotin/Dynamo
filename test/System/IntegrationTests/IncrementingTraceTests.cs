...
mtcAWasTraced = mtcA.WasCreatedWithTrace(); ";
            ...
            Assert.IsTrue(
                astLiveRunner.RuntimeCore.RuntimeData.CallsiteCache.First().Value.TraceData[0].HasNestedData);

            Assert.IsTrue(
                astLiveRunner.RuntimeCore.RuntimeData.CallsiteCache.First().Value.TraceData[0].NestedData.Count == 3);
